            ...
            <el-col :span="22" :offset="1" justify="center">
                ...
                <el-form ref="newEvent" :model="newEvent" label-width="20px">
                    ...
                    <el-form-item label=" " required>
                        <el-date-picker v-model="newEvent.date" type="date" value-format="yyyy-MM-dd" placeholder="Pick a day">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item label=" " required>
                        <el-time-select v-model="newEvent.time" :picker-options="{
    start: '06:30',
    step: '00:15',
    end: '23:30'
  }" value-format="HH:mm:ss" placeholder="Select time">
                        </el-time-select>
                    </el-form-item>
                    <el-form-item label=" " required>
                    ...
                    <el-form-item label=" " required>
                        <el-input type="textarea" autosize placeholder="What's going on?" v-model="newEvent.description">
                        </el-input>
                    </el-form-item>
                    <el-form-item label=" ">
                    ...
                    <el-form-item label=" ">
                        <span>
                            {{ num1 }} + {{ num2 }} = <input placeholder="??" size="5" v-model="newEvent.numnum"/>
                        </span>
                    </el-form-item>
        ...
        <div v-if="addEvent == false">
            ...
            <div v-if="addEvent == false">
              <el-row v-for="e in events" :key="e.id" :gutter="24" type="flex" class="row-bg" justify="center">
